 ...
 * If a valid token is present, the corresponding user is authenticated in the SecurityContext.
 */
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     * @return The JWT string if present and properly formatted, otherwise null.
     */
